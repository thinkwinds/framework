...
<body style="width: 700px; height: 500px;">
  <form class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manage.area.addSave') }}" method="post">
    {!! tw_csrf() !!}
      ...
      <div class="hstui-frame-content">
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('areaid')) hstui-form-error @endif" id="J_form_error_areaid">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="areaid" id="thinkwinds_areaid" value="{{ tw_value('areaid') }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('zip')) hstui-form-error @endif" id="J_form_error_zip">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="zip" id="thinkwinds_zip" value="{{ tw_value('zip') }}" class="hstui-input hstui-length-5">
