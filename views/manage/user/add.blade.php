...
<body>
<form method="post" class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manage.user.addSave') }}">
    {{ tw_csrf() }}
      ...
      <div class="hstui-frame-content">
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('gid')) hstui-form-error @endif" id="J_form_error_gid">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
                <select name="gid" id="thinkwinds_gid" class="hstui-input hstui-length-2">
                    <option value="">{{ tw_lang('thinkwinds::manage.select.role') }}</option>
                    @foreach($roles as $key=>$val)
                    <option value="{{ $val['id'] }}">{{ $val['name'] }}</option>
                    @endforeach
                </select>
            <div class="hstui-form-input-tips" id="J_form_tips_gid" data-tips=""></div>
          </div>
        </div>
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('username')) hstui-form-error @endif" id="J_form_error_username">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="username" id="thinkwinds_username" value="{{ tw_value('username') }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('mobile')) hstui-form-error @endif" id="J_form_error_mobile">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="mobile" id="thinkwinds_mobile" value="{{ tw_value('mobile') }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('email')) hstui-form-error @endif" id="J_form_error_email">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="email" id="thinkwinds_email" value="{{ tw_value('email') }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('qq')) hstui-form-error @endif" id="J_form_error_qq">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="qq" id="thinkwinds_qq" value="{{ tw_value('qq') }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('weixin')) hstui-form-error @endif" id="J_form_error_weixin">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="weixin" id="thinkwinds_weixin" value="{{ tw_value('email') }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('status')) hstui-form-error @endif" id="J_form_error_status">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
            <input type="checkbox" name="status" id="thinkwinds_status" data-class="hstui-switchx-default hstui-round hstui-mr-lg" data-switchx-offtext="{{ tw_lang('thinkwinds::public.disable')}}" data-switchx-ontext="{{ tw_lang('thinkwinds::public.enable')}}" data-hstui-switchx checked data-switchx-text="status"/>
