...
<body style="width: 720px; height: 450px">
  <form class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manage.form.editSave', ['module'=>$module, 'relatedid'=>$relatedid]) }}" method="post">
    {!! tw_csrf() !!}
      ...
      <div class="hstui-frame-content">
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('name')) hstui-form-error @endif" id="J_form_error_name">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="name" id="thinkwinds_name" value="{{ tw_value('name', $info) }}" class="hstui-input hstui-length-3">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('table')) hstui-form-error @endif" id="J_form_error_table">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="table" id="thinkwinds_table" value="{{ tw_value('table', $info) }}" readonly class="hstui-input hstui-length-3">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('mobile')) hstui-form-error @endif" id="J_form_error_mobile">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="mobile" id="thinkwinds_mobile" value="{{ tw_value('mobile', $info['setting']) }}" class="hstui-input hstui-length-3">
            <div class="hstui-form-input-tips hstui-u-sm-8" id="J_form_tips_mobile" data-tips="{!! tw_lang('thinkwinds::manage.form.mobile.notice.tips') !!}">{!! tw_lang('thinkwinds::manage.form.mobile.notice.tips') !!}</div>
          </div>
        </div>
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('email')) hstui-form-error @endif" id="J_form_error_email">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="email" id="thinkwinds_email" value="{{ tw_value('email', $info['setting']) }}" class="hstui-input hstui-length-3">
            <div class="hstui-form-input-tips hstui-u-sm-8" id="J_form_tips_email" data-tips="{!! tw_lang('thinkwinds::manage.form.email.notice.tips') !!}">{!! tw_lang('thinkwinds::manage.form.email.notice.tips') !!}</div>
          </div>
        </div>
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('emailcontent')) hstui-form-error @endif" id="J_form_error_emailcontent">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <textarea class="hstui-input hstui-textarea hstui-length-4" style="height: 120px" name="emailcontent" id="thinkwinds_emailcontent">{{ tw_value('email_content', $info['setting']) }}</textarea>
