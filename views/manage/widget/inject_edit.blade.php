...
<form method="post" class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manage.widget.inject.editSave', ['name'=>$widget_name]) }}">
<input type="hidden" name="id" value="{!! $id !!}">
<input type="hidden" name="alias" value="{{ tw_value('alias', $info) }}">
    {{ tw_csrf() }}
      ...
      <div class="hstui-frame-content">
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('name')) hstui-form-error @endif" id="J_form_error_name">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" readonly value="{{ $widget_name }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('alias')) hstui-form-error @endif" id="J_form_error_alias">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" readonly value="{{ tw_value('alias', $info) }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('files')) hstui-form-error @endif" id="J_form_error_files">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="files" id="thinkwinds_files" value="{{ tw_value('files', $info) }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('class')) hstui-form-error @endif" id="J_form_error_class">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="class" id="thinkwinds_class" value="{{ tw_value('class', $info) }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('fun')) hstui-form-error @endif" id="J_form_error_fun">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="fun" id="thinkwinds_fun" value="{{ tw_value('fun', $info) }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('description')) hstui-form-error @endif" id="J_form_error_description">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
                <textarea name="description" id="thinkwinds_description" class="hstui-input hstui-textarea hstui-length-4" placeholder="" style="height: 120px">{{ tw_value('description', $info) }}</textarea>
