...
<form method="post" class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manage.widget.editSave') }}">
    <input type="hidden" name="name" id="thinkwinds_name" class="hstui-form-field hstui-length-4" value="{{ $name }}" placeholder="">
    {{ tw_csrf() }}
    <div class="hstui-frame">
      <div class="hstui-frame-content">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('description')) hstui-form-error @endif" id="J_form_error_description">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="description" id="thinkwinds_description" value="{{ tw_value('description', $info) }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('document', $info)) hstui-form-error @endif" id="J_form_error_document">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
                <textarea name="document" id="thinkwinds_document" class="hstui-input hstui-textarea hstui-length-4" placeholder="" style="height: 120px">{{ tw_value('document', $info) }}</textarea>
