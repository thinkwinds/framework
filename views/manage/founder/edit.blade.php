...
<form method="post" class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manage.founder.editSave') }}">
    <input type="hidden" name="uid" value="{{ tw_value('uid', $info) }}">
    {{ tw_csrf() }}
      ...
      <div class="hstui-frame-content">
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('username')) hstui-form-error @endif" id="J_form_error_username">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="username" id="thinkwinds_username" value="{{ tw_value('username', $info) }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('mobile')) hstui-form-error @endif" id="J_form_error_mobile">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="mobile" id="thinkwinds_mobile" value="{{ tw_value('mobile', $info) }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('email')) hstui-form-error @endif" id="J_form_error_email">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="email" id="thinkwinds_email" value="{{ tw_value('email', $info) }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('qq')) hstui-form-error @endif" id="J_form_error_qq">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="qq" id="thinkwinds_qq" value="{{ tw_value('qq', $info) }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('weixin')) hstui-form-error @endif" id="J_form_error_weixin">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="weixin" id="thinkwinds_weixin" value="{{ tw_value('weixin', $info) }}" class="hstui-input hstui-length-4">
