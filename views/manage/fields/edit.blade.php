...
<div class="manage-content">
  {!! $navs !!}
  <form class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manage.fields.editSave') }}" method="post">
    {!! tw_csrf() !!}
    ...
    <div class="hstui-frame">
      <div class="hstui-frame-content">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('fieldname')) hstui-form-error @endif" id="J_form_error_fieldname">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="fieldname" id="thinkwinds_fieldname" value="{{ tw_value('fieldname', $info) }}" readonly class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('vieworder')) hstui-form-error @endif" id="J_form_error_vieworder">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="vieworder" id="thinkwinds_vieworder" value="{{ tw_value('vieworder', $info) }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('disabled')) hstui-form-error @endif" id="J_form_error_disabled">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="checkbox" name="disabled" id="thinkwinds_disabled" data-class="hstui-switchx-default hstui-round hstui-fl hstui-mr-sm" data-switchx-offtext="{{ tw_lang('thinkwinds::public.closes')}}" data-switchx-ontext="{{ tw_lang('thinkwinds::public.opens')}}" data-hstui-switchx @if(old('disabled')) {{ tw_ifCheck(old('disabled')) }} @else {{ tw_ifCheck(!tw_value('disabled', $info)) }} @endif data-switchx-text="disabled"/>
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('fieldtype')) hstui-form-error @endif" id="J_form_error_fieldtype">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <select class="hstui-input hstui-select" disabled readonly name="fieldtype" id="thinkwinds_fieldtype">
                <option value="">{{ tw_lang('thinkwinds::public.please.select') }}</option>
                @foreach($fieldTypes as $fieldType)
                <option value="{{ $fieldType['id'] }}" {{ tw_isSelected($info['fieldtype'] == $fieldType['id']) }}>{{ $fieldType['name'] }}</option>
                @endforeach
              </select>
      ...
      <div class="hstui-frame-content">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('isrequired')) hstui-form-error @endif" id="J_form_error_isrequired">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <label><input type="radio" value="0" onClick="set_required(0)" name="setting[validate][required]" {{ tw_ifCheck(!tw_value('required', $info['setting']['validate'])) }}><span>{{ tw_lang('thinkwinds::public.no') }}</span></label>
              <label><input type="radio" value="1" onClick="set_required(1)" name="setting[validate][required]" {{ tw_ifCheck(tw_value('required', $info['setting']['validate'])) }}><span>{{ tw_lang('thinkwinds::public.yes') }}</span></label>
        ...
        <div id="required" class="hstui-form-group hstui-form-group-sm" @if(!$info['setting']['validate']['required'])style="display: none;" @endif >
          <div class="hstui-form-group hstui-form-group-sm" id="J_form_error_pattern">
            ...
            <div class="hstui-u-sm-10 hstui-form-input">
                <input type="text" name="setting[validate][pattern]" id="thinkwinds_pattern" value="{{ tw_value('pattern', $info['setting']['validate']) }}" class="hstui-input hstui-length-3">
          ...
          <div class="hstui-form-group hstui-form-group-sm" id="J_form_error_errortips">
            ...
            <div class="hstui-u-sm-10 hstui-form-input">
                <input type="text" name="setting[validate][errortips]" id="thinkwinds_errortips" value="{{ tw_value('errortips', $info['setting']['validate']) }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm" id="J_form_error_v_tips">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="setting[validate][tips]" id="thinkwinds_v_tips" value="{{ tw_value('tips', $info['setting']['validate']) }}" class="hstui-input hstui-length-5">
...
function show_field_option(type) {
  $("#tw_loading").show();
  $.get('{!! route('manage.public.fields.type.html', ['id'=>$info['id'], 'relatedid'=>$relatedid, 'rname'=>$rname]) !!}&rand='+Math.random(),{ type:type}, function(data){
    $('#tw_option').html(data);
    $("#tw_loading").hide();
  });
}
