...
class Select extends FieldAbs 
{
    ...
    {
		parent::__construct();
		$this->name = tw_lang('thinkwinds::fields.select'); // 字段名称
		...
		return '
			<div class="hstui-form-group hstui-form-group-sm">
	          ...
	          <div class="hstui-u-sm-10 hstui-form-input">
	            ...
	            <div class="hstui-form-input-tips" id="J_form_tips_name">'.tw_lang('thinkwinds::fields.select.list.tips').'</div>
	          </div>
	        </div>
	...
	public function input($cname, $name, $cfg, $value = NULL, $id = 0) 
	{
		...
		$str = '<select '.$disabled.' name="'.$name.'" id="thinkwinds_'.$name.'" class="hstui-select" '.$attr.' >';
		if ($options) 
		{
