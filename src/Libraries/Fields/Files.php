...
class Files extends FieldAbs 
{
    ...
    {
		parent::__construct();
		$this->name = tw_lang('thinkwinds::fields.files'); // 字段名称
	...
	public function option($option) 
	{
		...
		return '
			...
			<div class="hstui-form-group hstui-form-group-sm">
	          <label class="hstui-u-sm-2 hstui-form-label">'.tw_lang('thinkwinds::fields.file.multi.num').'</label>
	          <div class="hstui-u-sm-10 hstui-form-input">
	              <input type="text" name="setting[option][multiNum]" value="'.$option['multiNum'].'" class="hstui-input hstui-length-5">
	            <div class="hstui-form-input-tips" id="J_form_tips_multiNum" data-tips="'.tw_lang('thinkwinds::fields.file.multi.num.tips').'">'.tw_lang('thinkwinds::fields.file.multi.num.tips').'</div>
	          </div>
	        </div> 
			<div class="hstui-form-group hstui-form-group-sm">
